...
<html lang="en" dir="ltr">
	<head>
        ...
        @include('admin.layouts.verticalmenu.vertical-toggle.styles')
	...
	<body class="app sidebar-mini ">
		...
		<div class="page">
			<div class="page-main">
				...
				<div class="container-fluid bg-white news-ticker">
					...
					@include('admin.layouts.components.news-ticket')

				</div>
				<!--/News Ticker-->

                @include('admin.layouts.verticalmenu.vertical-horizontal-combined.sidebar-menu')
        ...
        @include('admin.layouts.verticalmenu.vertical-toggle.scripts')
